...
const createElements = ()=>{
    ...
    const ccsingle = (0, _redom.el)("div#ccsingle", (0, _redom.el)("img", {
        src: "../img/reshot-icon-telegram-LSZVDUKX6M.svg",
        alt: "\u043B\u043E\u0433\u043E\u0442\u0438\u043F"
    })); // logo
    ...
    const cardBack = (0, _redom.el)("svg#cardback", {
        version: "1.1",
        xmlns: "http://www.w3.org/2000/svg",
        xmlnsXlink: "http://www.w3.org/1999/xlink",
        width: "750",
        ...
        (0, _redom.el)("g", {
            ...
            (0, _redom.el)("g", [
                ...
                (0, _redom.el)("path", {
                    class: "st5",
                    d: "M701.1,184.6H618h-8h-10v64.5h10h8h83.1c3.3,0,6-2.7,6-6v-52.5 C707.1,187.3,704.4,184.6,701.1,184.6z"
                })
            ]),
            (0, _redom.el)("text", {
